  ...
  peopleList = [
    {
      title: 'Val Neekman',
      description:
        'Val is responsible for defining the overall business strategy for the firm, including time allocated to sales and operations. Val brings more than 20 years of experience to the firm. He previously served as founder and CEO of Neekware Inc, which in 2008 he pivoted to a software consultancy. Val holds a bachelor of engineering from Carleton University. Val lives in Ontario Canada.',
